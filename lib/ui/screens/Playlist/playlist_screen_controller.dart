...
import 'package:musify/models/thumbnail.dart';
import 'package:musify/services/permission_service.dart';
import 'package:musify/ui/screens/Settings/settings_screen_controller.dart';
import 'package:musify/ui/widgets/snackbar.dart';
...
class PlaylistScreenController extends PlaylistAlbumScreenControllerBase
  ...
  String _getLocationMessage(String path) {
    if (Platform.isAndroid) {
      return "Downloads/Musify";
    } else if (Platform.isIOS) {
      return "Files App > Musify";
    } else if (Platform.isWindows || Platform.isLinux || Platform.isMacOS) {
      return "Downloads/Musify";
    } else {
